...
def service_request_to_trip_context(request: Dict[str, Any]) -> Dict[str, Any]:
    return {
        ...
        "request_time_source": request.get("request_time_source"),
        "request_local_hour": request.get("request_local_hour"),
        "request_timezone": request.get("request_timezone"),
        "request_local_iso": request.get("request_local_iso"),
        "map_name": request.get("map_name"),
        "od_provenance": dict(request.get("od_provenance") or {}),
        "hybrid_frontage_proxy_od": bool(request.get("hybrid_frontage_proxy_od", False)),
        "vehicle_assignment_method": request.get("vehicle_assignment_method"),
        "city_curb_side": request.get("city_curb_side"),
