...
class ClosedLoopRunner:
    ...
    def run_dataset(
        ...
        *,
        ...
        if version_upper.startswith("V15") and not self.config.no_viability_kernel and not self.config.v2_reference_runtime:
        ...
        eval_semantics = {
            ...
            "legacy_static_learned_guidance_enabled": bool((not self.config.no_learned_feasibility_guidance) and (
                (not str(self.config.algorithm_version).upper().startswith(("V11", "V12", "V13", "V14", "V15")))
