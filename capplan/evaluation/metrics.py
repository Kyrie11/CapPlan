...
def compute_all_metrics(episodes: List[Dict[str, Any]], counterfactual_pairs: List[Dict[str, Any]] | None = None) -> Dict[str, float]:
    ...
    metrics: Dict[str, float] = {
        ...
        "ECRP_summary_checks_mean": _construction_metric_mean(episodes, "exact_robustness_checks"),
        "ECRP_logical_summary_checks_mean": _construction_metric_mean(episodes, "exact_robustness_logical_checks"),
        "ECRP_scored_successors_mean": _construction_metric_mean(episodes, "exact_robustness_scored"),
        "ECRP_missing_successors_mean": _construction_metric_mean(episodes, "exact_robustness_missing"),
        "ECRP_group_adjusted_summaries_mean": _construction_metric_mean(episodes, "exact_robustness_group_adjusted"),
        "ECRP_group_rescued_summaries_mean": _construction_metric_mean(episodes, "exact_robustness_group_rescued"),
        "ECRP_cache_hits_mean": _construction_metric_mean(episodes, "exact_robustness_cache_hits"),
        ...
        "PCK_cache_hit_rate": _mean([float(e.get("parametric_kernel_cache_hit", 0.0)) for e in episodes]),
        "PCK_cache_hits_mean": _construction_metric_mean(episodes, "parametric_kernel_cache_hit"),
        "PCK_cache_misses_mean": _construction_metric_mean(episodes, "parametric_kernel_cache_miss"),
        "PCK_cache_entries_mean": _construction_metric_mean(episodes, "parametric_kernel_cache_entries"),
        "PCK_thresholds_erased_mean": _construction_metric_mean(episodes, "parametric_kernel_thresholds_erased"),
        "PCK_lookup_ms_mean": _construction_metric_mean(episodes, "parametric_kernel_lookup_ms"),
        "PCK_source_build_ms_mean": _construction_metric_mean(episodes, "parametric_kernel_source_build_ms"),
        ...
        "NQK_native_compositions_mean": _construction_metric_mean(episodes, "native_projected_compositions"),
        "NQK_native_materializations_mean": _construction_metric_mean(episodes, "native_projected_materializations"),
        "NQK_native_fallbacks_mean": _construction_metric_mean(episodes, "native_projected_fallbacks"),
        "NQK_fused_frontier_passes_mean": _construction_metric_mean(episodes, "fused_frontier_passes"),
