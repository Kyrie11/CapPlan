...
The registry keeps resource types explicit.  Resources are never collapsed into a
single scalar except in the intentionally unsafe ablation path.
"""
...
class ResourceType:
    ...
    evidence_source: str
    default_threshold_range: Tuple[float, float] | Tuple[str, str] | Tuple[bool, bool]
    description: str = ""
...
class ResourceRegistry:
    ...
    def _install_defaults(self) -> None:
        ...
        add(ResourceType("crossing_count", "count", "cumulative", "smaller", ("access", "egress"), "pedestrian_graph", (0.0, 6.0), "Number of pedestrian crossings."))
        add(ResourceType("wait_exposure_s", "s", "cumulative", "smaller", ("wait",), "service_trace", (30.0, 900.0), "Curbside waiting exposure."))
        add(ResourceType("motion_exposure", "score", "cumulative", "smaller", ("ride",), "trajectory", (0.5, 8.0), "Accumulated ride-motion burden."))
        add(ResourceType("ride_time_s", "s", "cumulative", "smaller", ("ride",), "trajectory", (180.0, 3600.0), "In-vehicle ride time."))
        ...
        add(ResourceType("door_side", "category", "categorical", "predicate", ("board", "alight"), "vehicle_spec+curbside_map", ("left", "right"), "Required door side."))
