...
SEED="${SEED:-13}"; GPU0="${GPU0:-0}"; ROBUSTNESS_WEIGHT="${ROBUSTNESS_WEIGHT:-0.35}"; CASA_CHECKPOINT="${CASA_CHECKPOINT:-$CAP_HOME/outputs/models/casa_relation_mlp_seed13/checkpoint.pt}"; V15_ROOT="${V15_ROOT:-$CAP_HOME/outputs/eval/v15r_full_seed${SEED}}"
