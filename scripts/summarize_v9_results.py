...
KEYS=[
    ...
    'DCP_rejection_antichain_size_mean','CPK_projected_resource_count_mean','CPK_projected_evidence_dropped_mean','CPK_frontier_signature_hits_mean','CPK_frontier_dominance_checks_mean','CPK_frontier_peak_size_mean','CPK_build_ms_mean','DiagnosticReplayRate','DiagnosticReplayExpansionsMean','DiagnosticReplayRescueRate',
]
